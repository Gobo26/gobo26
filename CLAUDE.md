...
| 2026-07-02 | **Bonoloto: retirat el filtre del rang de dates** a petició de l'usuari — ja no es limiten els números de l'1 al 31 (abans màx. 3 per combinació); les combinacions són lliures dins la resta de filtres. Tretes també la menció al modal d'ajuda i la dada «fora del rang de dates» de la línia d'informació |
