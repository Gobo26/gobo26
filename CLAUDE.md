...
| 2026-09-21 | **Taller de lletres retirat**: tret l'enllaç/targeta del portal (`index.html`: menú, secció Creació —ara "1 espai"—, footer) i de `README.md`. El repositori `Gobo26/Taller_de_lletres` i la còpia local `~/Taller_de_lletres` encara no s'han tocat |
